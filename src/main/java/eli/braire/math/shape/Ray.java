...
//
///**
// * An object corresponding to the abstract mathematical notion of a Ray. Rays consist of an origin
// * {@link Point} and an offset {@link Vector}. This also supports typical and relevant Ray
...
//    }
//
//    public static Ray create(final Point origin, final Vector offset)
//    {
//        Verifier.assertNotNull("Ray Point origin.", origin);
//        Verifier.assertNotNull("Ray Vector offset.", offset);
//        Verifier.Equality.assertEqual(
//                "Both Ray origin Point and Vector offset must have the same dimensionality.",
//                offset.RANK,
//                origin.RANK);
//
...
//    }
//
//    public static Ray create(final Point origin, final Point terminus)
//    {
//        Verifier.assertNotNull("Ray Point origin.", origin);
//        Verifier.assertNotNull("Ray Point terminus.", terminus);
//        Verifier.Equality.assertEqual(
//                "Both Ray origin and terminus Points must have the same dimensionality.",
//                terminus.RANK,
//                origin.RANK);
//
...
//
//    /**
//     * Determines the <code>t</code> scalar value on this {@link Line} closest to the provided
//     * {@link Point}
//     *
//     * @param point An arbitrary {@link Point} of the same rank as this {@link Line}. (Cannot be
//     *              null)
//     *
//     * @return A scalar value for the parameterized input for {@link #f(double)} corresponding to
//     *         the nearest {@link Point} on this {@link Line}.
//     *         <ul>
//     *         <li>Will be 0 or 1 if not between initial {@link Point} <code>a</code> and terminal
//     *         {@link Point} <code>b</code>.</li>
...
//     *         </ul>
//     */
//    private double closestApproach(final Point point)
//    {
//        // Formula: (P - A) * BA / BA^2
...
//
//    /**
//     * Calculates a {@link Point} on this {@link Line} relative to the parameterized input
//     * <code>t</code>.
//     *
...
//
//    /**
//     * Used when the literal magnitude of the distance is not necessary, and only direct distance
//     * comparisons are needed.
//     *
//     * @param point An arbitrary {@link Point} of the same rank as this {@link Line}. (Cannot be
//     *              null)
//     *
//     * @return A non-negative scalar value corresponding to the distance metric squared. Will be 0
//     *         if point is on the defined line.
//     */
//    public double euclideanDistance(final Point point)
//    {
//        // Formula: [(P - A) + t0 * BA]^2
...
//    }
//
//    public Collection<Point> findNearest(final Collection<Point> points)
//    {
...
//            Verifier.Equality.assertEqual(MessageFormat.format(
//                    "Comparison Points must have the same dimensionality: {0}",
...
//            System.out.println(MessageFormat.format("Ray: {0}; Point: {1}; Distance: {2}",
//                                                    this,
//                                                    point,
//                                                    distance));
...
//    }
//
//    private double calculateEuclideanDistance(final Point point)
//    {
